    ...
    <div class="widget-sec">
        ...
        <form method="post">
            <div class="form-group">
                ...
                <input name="old" type="password" class="form-control" id="text_element">
            </div>

            <div class="form-group">
                <label for="textelement">New Password</label>
                <input name="new" type="password" class="form-control" id="text_element" >
            </div>

            <div class="form-group">
                <label for="textelement">Confirm Password</label>
                <input name="re_password" type="password" class="form-control" id="text_element">
            </div>
            <div class="col-md-6">
