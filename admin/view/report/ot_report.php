        ...
        <div class="col-md-12">  
            ...
            <form method="post">
                <div class="col-md-3">
                    ...
                    <select id="company" style="width:200px" name="company_id">
                ...
                <div class="col-md-2">
                    <input value="Create Report" type="submit" id="SearchOT" class="k-button" name="SearchOT" style="width: 120px; margin-top: 20px; height:30px; padding-top:1px;"/>
