        ...
        if (count($employees) > 0) {
            ...
            while (list ($key, $val) = each($employees)) {
                foreach ($dates as $date) {
                    ...
                    $employees_code = $con->SelectAllByCondition("tmp_employee", "emp_id='$val'");
                    $tmp_emp_code = $employees_code{0}->emp_code;
...
//Check if terminate flag is on or not
                    if ($emp_company_id != $company_id) {
                        ...
                        $msg_terminated = "Swap partially successfull. <font color=\"red\">"
                        ...
                        if ($emp_company_id == $company_id) {
                            ...
                            if (count($output_diff_shift) > 0) {
                                ...
                                $msg = "Swap partially successfull! <font style=\"color:red\">However, following employees were already in another shift definition for specified date. They were unchanged.</font>";
                            ...
                            $err = "Submission Partially Successful. One or more employees are not from the same company selected for shift assignment.";
                        }
                    }
                }
            }
