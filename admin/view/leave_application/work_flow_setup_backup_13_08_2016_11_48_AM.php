...
//    
//    exit();
    $sqlSearch = "SELECT * FROM approval_workflow_settings WHERE emp_code_auth='" . $employee . "' AND department_id='" . $department . "'";
    ...
    <div class="widget-body" style="background-color: white;">
        ...
        <form method="post">
            ...
            <div class="col-md-4">
                ...
                <input type="text" id="employee" name="employee" placeholder=""  style="width: 80%;"/>
            </div>
