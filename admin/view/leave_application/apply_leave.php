...
//clearing temp table on page reload
if ($emp_code != "") {
    $sqlClearTemp = "DELETE FROM leave_application_temp WHERE emp_code='$emp_code'";
    $resultClearTemp = mysqli_query($con->open(), $sqlClearTemp);

    if (!$resultClearTemp) {
        "resultClearTemp query failed." . mysqli_error($con->open());
    }
}
    ...
    <div class="widget-body" style="background-color: white;">        
        ...
        <form method="post" id="myform">
            ...
            <div class="col-md-4">
                ...
                <input id="reason" maxlength="200" type="text" class="k-textbox" value="<?php echo $reason; ?>" name="reason" placeholder="" style="width: 80%;"/>
            </div>

            <div class="clearfix"></div><br />
            <div class="col-md-6" style="padding-top:18px;">
                <input type="checkbox" id="multiple_leave_types" name="multiple_leave_types">&nbsp; Apply for multiple leave types
            ...
            <script type="text/javascript">
                $(document).ready(function () {
                    ...
                    var dataSource = new kendo.data.DataSource({
                        ...
                        transport: {
                            read: {
                                url: "../../controller/leave_management_controllers/leave_application_temp_controller.php",
                                type: "GET"
                            },
                            update: {
                                url: "../../controller/leave_management_controllers/leave_application_temp_controller.php",
                    ...
                    $("#grid").kendoGrid({
                        ...
                        columns: [
                            ...
                            {field: "start_date_temp", title: "Start Date", id: "start_date_temp", width: "170px", format: "{0:dd-MM-yyyy}"},
                            {field: "end_date_temp", title: "End Date", id: "end_date_temp", width: "170px", format: "{0:dd-MM-yyyy}"},
                            {field: "replacement_date", title: "Replacement Date", id: "replacement_date", width: "170px", format: "{0:dd-MM-yyyy}"},
            ...
            <script type="text/javascript">
                ...
                function LeaveDropDownEditor(container, options) {
                    var dropdownlist = $('<input required data-text-field="leave_title" data-value-field="leave_policy_id" data-bind="value:' + options.field + '"/>')
                            .appendTo(container)
                            .kendoDropDownList({
                                autoBind: false,
                                change: onChangee,
                ...
                function onChangee()
                {
                    ...
                    //var idx = grid.select().closest("tr");
                    //console.log(idx);
                    console.log(grid);
                }
            </script>
            ...
            <div class="col-md-12">
                <br />
                <input type="button" id="save" class="k-button" value="Submit Request" name="save"><br/>
        ...
        <!--Grids to contain history and summary for normal users-->
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                var dataSource = new kendo.data.DataSource({
                    ...
                    transport: {
                        read: {
                            url: "../../controller/leave_management_controllers/leave_status_meta_controller.php?emp_code=" + emp_code + "",
                            type: "GET"
                        }
                    },
                    autoSync: false,
                ...
                var dataSource_two = new kendo.data.DataSource({
                    ...
                    transport: {
                        read: {
                            url: "../../controller/leave_management_controllers/leave_history_controller.php?emp_code=" + emp_code + "",
                            type: "GET"
                        }
                    },
                    autoSync: false,
                ...
                jQuery("#grid_two").kendoGrid({
                    ...
                    columns: [
                        ...
                        {field: "maxdate", title: "End Date", id: "maxdate", width: "150px", format: "{0:dd-MM-yyyy}"},
                        ...
                        {field: "reasons", title: "Remarks", id: "reasons", width: "250px"},
						{field: "review_remark", title: "Review Remark", id: "review_remark", width: "250px"}
                    ],
                    editable: "inline"
                });
            });</script>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $("#save").click(function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "../../controller/leave_management_controllers/single_leave_save_controller.php",
                        data: {
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $("#save_multiple").click(function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "../../controller/leave_management_controllers/multi_leave_details_controller.php",
                        data: {
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                $("#size9").change(function () {
                    ...
                    $.ajax({
                        url: "../../controller/leave_management_controllers/emp_leave_type_controller.php?leave_type_id=" + leave_type_id + "&emp_code=" + emp_code + "",
                        type: "GET",
                        dataType: "JSON",
                        success: function (data) {
            ...
            $(document).ready(function () {
                $("#end_date").change(function () {
                    ...
                    //if half_day is checked, then assign 0.5 to variable
                    if ($("#is_half").is(':checked')) {
                        var correctDiffDays = 0.5;
                    }
