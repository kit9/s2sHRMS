    ...
    <div class="widget-body">
        ...
        <form method="post" enctype="multipart/form-data" name="frm1">
            ...
            <div class="col-md-10" style="">
                <div style="height: auto; width:100%; border: 1px solid #72AF46;  min-height:200px; padding-top: 8px;" id="example" class="k-content">
                    <!---------------------------------------->
            ...
            <!--</div>--> 
            <!------------------------------------------------------------------------------>           
            <div class="widget" style="background-color: white; width:100%; margin-left: -1px;">
