...
if ($verb == "POST") {
    $allemp_array = array();
    $employe_rol = mysqli_query($open, "SELECT e.emp_code,e.emp_firstname FROM role_assign r left join tmp_employee e on e.emp_code=r.emp_code WHERE em_role_id='$emp_rol'");
