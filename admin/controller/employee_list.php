...
FROM
	tmp_employee AS tmp
WHERE
    tmp.emp_code NOT IN (SELECT emp_replacement_of FROM tmp_employee)");
    ...
    $dis_data->emp_name = "New";
    $dis_data->emp_id = "";
    $dis_data->emp_code = "New";
    $dis_data->emp_firstname = "";

    $array[] = $dis_data;
    foreach ($allemp_array as $data) {
