...
if ($verb == "GET") {
    $arr = array();
    $query = "select approval_workflow_settings.*, department.department_title, tmp_employee.emp_firstname,tmp_employee.emp_email_office,stm.emp_firstname as auth_emp FROM approval_workflow_settings
...
inner join tmp_employee as stm on stm.emp_code=approval_workflow_settings.emp_code_auth
