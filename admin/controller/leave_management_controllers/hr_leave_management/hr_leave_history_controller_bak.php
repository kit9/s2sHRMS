 ...
 */ $histories = array();
$history_query = "select  A.leave_application_master_id, A.leave_type_id, A.mindate, B.replacement_date, B.is_half, B.day_part, B.maxdate, A.details_no_of_days,  A.status, A.remarks, A.leave_title FROM
